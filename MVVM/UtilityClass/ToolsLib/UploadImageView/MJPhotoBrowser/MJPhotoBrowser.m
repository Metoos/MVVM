...
#define kPhoto_Distancebottom    ((([[UIApplication sharedApplication] statusBarFrame].size.height)>=44)?34.0f:0.0f)
...
- (void)createToolbar
{
    ...
    CGFloat barY = self.view.frame.size.height - barHeight-kPhoto_Distancebottom;
...
- (void)showPhotoViewAtIndex:(int)index
{
    ...
    if (!photoView) { // 添加新的图片view
        ...
        photoView.isForbidTap = self.isForbidTap;
