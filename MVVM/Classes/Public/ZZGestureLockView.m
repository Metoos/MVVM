...
- (void)initialization {
    ...
    for (NSInteger i = 0; i < 9; i++) {
        ...
        //set image
        [item setImage:[UIImage imageNamed:@"我的_手势白点"] forState:ZZGestureLockItemStateNormal];
        [item setImage:[UIImage imageNamed:@"我的_手势白点"] forState:ZZGestureLockItemStateSelected];
        [item setImage:[UIImage imageNamed:@"我的_手势红点"] forState:ZZGestureLockItemStateWarning];
        
//        [item setImage:[[UIImage jq_imageWithColor:kWhiteColor] circleImage] forState:ZZGestureLockItemStateNormal];
//        [item setImage:[[UIImage jq_imageWithColor:kGreenColor] circleImage] forState:ZZGestureLockItemStateSelected];
//        [item setImage:[[UIImage jq_imageWithColor:kRedColor] circleImage] forState:ZZGestureLockItemStateWarning];
